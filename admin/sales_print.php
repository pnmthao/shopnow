<?php
	...
	if(isset($_POST['print'])){
	    ...
	    $content = '';  
	    $content .= '
	      	<h2 align="center">Giải pháp CNTT</h2>
	      	<h4 align="center">Báo Cáo Đơn Hàng</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Ngày</b></th>
	                <th width="30%" align="center"><b>Tên Người Mua</b></th>
					<th width="40%" align="center"><b>Giao Dịch#</b></th>
					<th width="15%" align="center"><b>Số Tiền</b></th>  
	           </tr>  
	      ';  
		...
		$_SESSION['error'] = 'Cần khoảng ngày để in';

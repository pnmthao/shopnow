	        				...
	        				<div class="col-sm-9">
	        					<div class="row">
	        						<div class="col-sm-3">
	        							...
	        							<h4>Địa Chỉ:</h4>
	        							<h4>Thành Viên từ ngày:</h4>
	        						</div>
	        						<div class="col-sm-9">
	        							<h4><?php echo $user['firstname'].' '.$user['lastname']; ?>
	        								<span class="pull-right">
	        									<a href="#edit" class="btn btn-success btn-flat btn-sm" data-toggle="modal"><i class="fa fa-edit"></i> Sửa</a>
	        								</span>
	        							</h4>
	        							...
	        							foreach($stmt as $row){
	        								...
	        								echo "
	        									<tr>
	        										...
	        										<td><button class='btn btn-sm btn-flat btn-info transact' data-id='".$row['id']."'><i class='fa fa-search'></i> Xem</button></td>
	        									</tr>
	        								";
	        							}

...
<div class="register-box">
    ...
    ?>
  	<div class="register-box-body">
    	<p class="login-box-msg col-lg-4 col-centered">Đăng Ký</p>
      <br>
    	<form action="register.php" method="POST" class="form1">
          ...
          <hr>-->
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="signup" id="btnSignUp"><i class="fa fa-pencil"></i> OK</button>
        		</div>
      		</div>
    	</form>
      <br>
